                            ...
                            <table id="simple-table" class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="center">
                                            <label class="pos-rel">
                                                <input type="checkbox" value="{{$genres->id}}" class="ace ids" />
                                                <span class="lbl"></span>
                                            </label>
                                        </td>
                                        <td class="center">{{ $genres->title }}</td>
                                        <td class="center">
                                            <div class="hidden-sm hidden-xs btn-group">
                                                @php
                                                $editURI = 'admin/genreses/' . $genres->id . '/edit';
                                                @endphp
                                                <a href="{{ url($editURI) }}" class="btn btn-xs btn-info">
                                                    <i class="ace-icon fa fa-pencil bigger-120"></i>
                                                </a>

                                                <button data="{{ $genres->id }}" id="btnDelete{{ $genres->id }}"
