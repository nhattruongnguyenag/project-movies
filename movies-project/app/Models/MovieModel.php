...
class MovieModel extends Model
{
    ...
    function genreses()
    {
        return self::belongsToMany(GenresModel::class, "genreses_movies", "movie_id", "genres_id");
    }

    function category()
    {
        return self::hasOne(CategoryModel::class, "id", "category_id");
    }
    ...
    function saveOrUpdate($requestObject)
    {
        if (isset($requestObject->id)) {
            $movie = self::findById($requestObject->id);
    ...
    function episodes()
    {
        return self::hasMany(EpisodeModel::class, 'move_id', 'id')->get();
    }
